          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" style="height: 100%">
                <img src="assets/img/bg-exotic.jpeg" class="d-block" style="width:100%; max-width: 100%; max-height: 100vh; object-fit: fill; filter: brightness(50%)" alt="...">
              ...
              <div class="carousel-item" style="height: 100%">
                <img src="assets/img/bg-rare.jpeg" class="d-block" style="width:100%; max-width: 100%; max-height: 100vh; object-fit: fill; filter: brightness(50%)" alt="...">
              ...
              <div class="carousel-item" style="height: 100%">
                <img src="assets/img/bg-caladium.jpeg" class="d-block " style="width:100%; max-width: 100%; max-height: 100vh; object-fit: fill; filter: brightness(50%)" alt="...">
        ...
        <div class="container mt-3">
          <div class="row no-gutters">
            ...
            >
              ...
              @endforeach -->
              <div class="col-lg-4 col-md-6 p-3">
                  <div class="shadow pb-3" style="width: 17rem; max-height: 400px; min-height: 570px; width: 320px; background-color: #315343;">
                  <a href="/menu-products/category/6" style="text-decoration: none; color: white; font-weight: 300">
                  <img
                    src="{{ asset('img/DSC02947.jpg') }}"
                    alt="aaa"
              ...
              <div class="col-lg-4 col-md-6 p-3">
                  <div class="shadow pb-3" style="width: 17rem; max-height: 400px; min-height: 570px; width: 320px; background-color: #315343;">
                  <a href="/menu-products/category/2" style="text-decoration: none; color: white; font-weight: 300">
                  <img
                    src="{{ asset('img/DSC02935.jpg') }}"
                    alt="aaa"
                    style="width: 320px; max-height: 400px"
                  />
                  <h4 class="text-wrap mt-4 mb-3" style="text-align: left; padding: 0 20px">
                  ...
                  <p class="hide-scrollbar text-wrap p-text px-3 pl-4" style="padding: 0 20px; margin-bottom: 10px; letter-spacing: 0.3px text-decoration: none;font-size: 1.1rem; color: white; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical;">
                  Alocasia is sometimes known as the Kris Plant, Elephant Ear or African mask plant.
                  </p>
                  <span class="px-3 pl-4 " style="padding: 0 20px">Read more <i class="fas fa-angle-right"></i> </span>
                  </a>
                </div>
              ...
              <div class="col-lg-4 col-md-6 p-3">
                  <div class="shadow pb-3" style="width: 17rem; max-height: 400px; min-height: 570px; width: 320px; background-color: #315343;">
                  <a href="/menu-products/category/15" style="text-decoration: none; color: white; font-weight: 300">
                  <img
                    src="{{ asset('img/DSC01503.jpg') }}"
                    alt="aaa"
                    style="width: 320px; max-height: 400px"
                  />
                  <h4 class="text-wrap mt-4 mb-3" style="text-align: left; padding: 0 20px">
